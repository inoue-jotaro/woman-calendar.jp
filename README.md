...
### 1. ローカルにプロジェクトを作成
```ShellSession
$ git clone git@github.com:baby-calendar-hosts/hosting-wordpress.git <ドメイン名>
$ cd <ドメイン名>
```
...
$ git remote add upstream git@github.com:baby-calendar-hosts/hosting-wordpress.git
$ git push
```
